...
DragonLink is a 433MHz UHF RC system. Compared to other UHF systems, its primary advantage is its support for the CRSF protocol, which offers a very low latency control link with integral telemetry data downlink.
